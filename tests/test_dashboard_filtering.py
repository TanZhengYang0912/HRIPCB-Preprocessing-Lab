...
def sample_records():
    return [
        ...
        {"id": "member2_wavelet", "model_id": "baseline", "module": "member2", "technique": "wavelet", "split": "val"},
        {"id": "member2_homomorphic", "model_id": "baseline", "module": "member2", "technique": "homomorphic", "split": "val"},
...
def test_member2_options_only_include_member2_techniques(sample_records):
    ...
    assert options["technique"] == ["homomorphic", "wavelet"]
...
def test_filter_records_applies_all_active_values(sample_records):
    filtered = filter_records(sample_records, model="baseline", split="val", module="member2", technique="wavelet")
    assert [record["id"] for record in filtered] == ["member2_wavelet"]


def test_best_experiment_uses_validation_ablation_and_map5095():
    records = [
        {"id": "val_best", "module": "member2", "technique": "wavelet_homomorphic", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.8}},
...
def test_best_experiment_ignores_higher_scoring_single_technique():
    records = [
        {"id": "noise_only", "module": "member2", "technique": "wavelet", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.95}},
        {"id": "combined", "module": "member2", "technique": "wavelet_homomorphic", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.80}},
    ]
...
def test_best_by_module_returns_one_recommendation_per_module():
    records = [
        ...
        {"id": "member2_best", "module": "member2", "technique": "wavelet_homomorphic", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.5}},
    ]
