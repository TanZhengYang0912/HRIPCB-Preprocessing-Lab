...
def test_best_experiment_uses_validation_ablation_and_map5095():
    records = [
        {"id": "val_best", "module": "member2", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.8}},
...
def test_best_by_module_returns_one_recommendation_per_module():
    records = [
        {"id": "member1_low", "module": "member1", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.4}},
        {"id": "member1_high", "module": "member1", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.6}},
        {"id": "member2_best", "module": "member2", "split": "val", "evaluation_type": "ablation", "metrics": {"map50_95": 0.5}},
    ]
    assert {record["id"] for record in best_by_module(records)} == {"member1_high", "member2_best"}
