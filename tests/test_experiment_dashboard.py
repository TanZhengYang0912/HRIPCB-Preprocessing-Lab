...
def test_dashboard_renders_dynamic_module_parameters_and_metrics(tmp_path):
    records = [
        ...
        {
            "id": "member2_wavelet_homomorphic",
            "module": "member2",
            "technique": "wavelet_homomorphic",
            "parameters": {"wavelet_name": "sym4", "homomorphic_cutoff": 30.0},
            "metrics": {"map50_95": 0.512, "recall": 0.94},
            "preview": "previews/member2_wavelet_homomorphic.jpg",
        },
    ]
    ...
    assert "homomorphic_cutoff" in html
    assert "wavelet_homomorphic" in html
    assert "mAP50-95" in html
    assert "member2_wavelet_homomorphic.jpg" in html
